              ...
              {selectedAlgorithm === "RSA" && (
                <>
                  ...
                  <div className="bg-grey-800 p-6 mt-4 rounded-md">
                    ...
                    <p>
                      <strong>RSA (Rivest–Shamir–Adleman)</strong> is an
                      asymmetric cryptographic algorithm used for secure data
                      transmission. It uses a pair of keys: a public key for
                    ...
                    <ul className="list-disc pl-5">
                      <li>
                        Introduced in 1977 by Ron Rivest, Adi Shamir, and
                        Leonard Adleman.
                      </li>
                      <li>
                    ...
                    <ul className="list-disc pl-5">
                      <li className="text-l font-bold mt-2">
                      ...
                      <ul className="list-disc pl-5">
                        <li>
                          ϕ(n)=(p−1)(q−1) where 𝑝 and q are prime numbers.
                        </li>
                      </ul>
                    </ul>
                  </div>
                  <div className="bg-green-800 p-6 mt-4 rounded-md">
                    ...
                    <ol className="list-decimal pl-5">
                      ...
                      <li>
                        <strong>
                          Choose an integer e such that 1‹e‹ϕ(n) and
                          gcd(e,ϕ(n))=1.
                        </strong>
                      </li>
                      <ul className="list-disc pl-5">
                      ...
                      <ul className="list-disc pl-5">
                        <li>
                          Example: d=2753 (found using Extended Euclidean
                          Algorithm).
                        </li>
                      </ul>
                    </ol>
                  ...
                  <div className="bg-green-800 p-6 mt-4 rounded-md">
                    ...
                    <ol className="list-decimal pl-5">
                      <li>
                        <strong>
                          Convert plaintext message to an integer 0≤m‹n.
                        </strong>
                      </li>
                      <ul className="list-disc pl-5">
                        <li>
                          Example: Plaintext "HI" converted to numeric m=72.
                        </li>
                      </ul>
                      <li>
                        <strong>
                          Compute the ciphertext c using c=m^e modn.
                        </strong>
                      </li>
                      <ul className="list-disc pl-5">
                    ...
                    <ol className="list-decimal pl-5">
                      <li>
                        <strong>
                          Compute the original message m using m=c^d mod n.
                        </strong>
                      </li>
                      <ul className="list-disc pl-5">
                  ...
                  <div className="bg-green-800 p-6 mt-4 rounded-md">
                    ...
                    <ul className="list-disc pl-5">
                      <li>
                        Input: Plaintext and Public Key for encryption;
                        Ciphertext and Private Key for decryption.
                      </li>
                      <li>
                        ...
                        <div className="grid grid-cols-3 gap-4">
                          ...
                          >
                            ...
                            <p style={{ marginTop: "8px", fontSize: "14px" }}>
                              ...
                              RSA Algorithm Explained | Simplilearn
                            </p>
                          </a>
                          <a
              ...
              {selectedAlgorithm === "AES" && (
                <>
                  ...
                  <div className="bg-green-800 p-6 mt-4 rounded-md">
                    <h1 className="text-xl font-bold mb-2">Introduction</h1>
                    <p>
                      <strong>AES (Advanced Encryption Standard)</strong> is a
                      symmetric encryption algorithm used globally to secure
                      data.
                    </p>
                    <h2 className="text-l font-bold mt-2">
                      Historical Context
                    ...
                    <ul className="list-disc pl-5">
                      <li>
                        Standardized by NIST in 2001, developed by Joan Daemen
                        and Vincent Rijmen.
                      </li>
                    </ul>
                  ...
                  <div className="bg-green-800 p-6 mt-4 rounded-md">
                    ...
                    <ul className="list-disc pl-5">
                      ...
                      <ul className="list-disc pl-5">
                        <li>
                          Expands the cipher key into a series of round keys.
                        </li>
                        <li>
                          The number of rounds depends on the key size: 10, 12,
                          or 14 rounds.
                        </li>
                      </ul>
                    </ul>
                    <h1 className="text-xl font-bold mt-2 mb-2">
                      Steps for 128-bit Key
                    </h1>
                    <ol className="list-decimal pl-5">
                      <li>
                      ...
                      <ul className="list-disc pl-5">
                        <li>
                          Generate an array of words (32-bit each) from the
                          initial key.
                        </li>
                        <li>
                          Perform transformations on the initial key to produce
                          round keys.
                        </li>
                      </ul>
                    </ol>
                  ...
                  <div className="bg-green-800 p-6 mt-4 rounded-md">
                    ...
                    <ul className="list-disc pl-5">
                      <li>
                        Initial AddRoundKey and 10 rounds of transformations.
                      </li>
                    </ul>
                    <h1 className="text-xl font-bold mb-2 mt-2">Decryption:</h1>
                    <ul className="list-disc pl-5">
                      ...
                      <div className="flex justify-center">
                        <div className="grid grid-cols-3 gap-4">
                          ...
                          >
                            ...
                            />
                            <p style={{ marginTop: "8px", fontSize: "14px" }}>
                              AES - Advanced Encryption Standard Algorithm In
                              Cryptography | AES Explained | Simplilearn
                            </p>
                          </a>
                          <a
