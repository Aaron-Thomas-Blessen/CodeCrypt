      ...
      <div className="flex flex-col items-center p-6 bg-gray-900 min-h-screen text-white">
        ...
        <div className="mb-4">
          <button
            ...
            className={`px-4 py-2 mr-2 ${decryptionType === 'aes' ? 'bg-blue-500' : 'bg-gray-700'} text-white rounded-md hover:bg-blue-600`}
          >
            AES
          </button>
          <button
            onClick={() => setDecryptionType('rsa')}
            className={`px-4 py-2 mr-2 ${decryptionType === 'rsa' ? 'bg-blue-500' : 'bg-gray-700'} text-white rounded-md hover:bg-blue-600`}
          >
            RSA
          </button>
          <button
            onClick={() => setDecryptionType('dsa')}
            className={`px-4 py-2 mr-2 ${decryptionType === 'dsa' ? 'bg-blue-500' : 'bg-gray-700'} text-white rounded-md hover:bg-blue-600`}
          >
            DSA
          </button>
          <button
            onClick={() => setDecryptionType('sha')}
            className={`px-4 py-2 ${decryptionType === 'sha' ? 'bg-blue-500' : 'bg-gray-700'} text-white rounded-md hover:bg-blue-600`}
          >
            SHA
          </button>
        </div>
