            ...
            <div className="flex items-center justify-center"> 
              ...
              <button
                ...
                className={`px-8 py-4 text-xl font-bold text-white bg-gradient-to-r from-blue-gray-700 to-teal-800 rounded-md shadow-md
                            ...
                            ${decryptionType === "text" ? "border-4 border-blue-300" : ""} flex items-center justify-center`}
              >
              Text Decryption
            </button>
            <button
                ...
                className={`px-8 py-4 text-xl font-bold text-white bg-gradient-to-r from-blue-gray-700 to-teal-800 rounded-md shadow-md
                            hover:scale-105 hover:shadow-lg transition-all duration-300
                            ${decryptionType === "file" ? "border-4 border-blue-300" : ""} flex items-center justify-center`}
              >
              File Decryption
            </button>
            <button
                ...
                className={`px-8 py-4 text-xl font-bold text-white bg-gradient-to-r from-blue-gray-700 to-teal-800 rounded-md shadow-md
                            hover:scale-105 hover:shadow-lg transition-all duration-300
                            ${decryptionType === "audio" ? "border-4 border-blue-300" : ""} flex items-center justify-center`}
              >
              Audio Decryption
            </button>
            <button
                ...
                className={`px-8 py-4 text-xl font-bold text-white bg-gradient-to-r from-blue-gray-700 to-teal-800 rounded-md shadow-md
                            hover:scale-105 hover:shadow-lg transition-all duration-300
                            ${decryptionType === "image" ? "border-4 border-blue-300" : ""} flex items-center justify-center`}
              >
              Image Decryption
            </button>
            <button
                ...
                className={`px-8 py-4 text-xl font-bold text-white bg-gradient-to-r from-blue-gray-700 to-teal-800 rounded-md shadow-md
                            hover:scale-105 hover:shadow-lg transition-all duration-300
                            ${decryptionType === "video" ? "border-4 border-blue-300" : ""} flex items-center justify-center`}
              >
              Video Decryption
            </button>
              </div>
           ...
           <div className="bg-gradient-to-r from-gray-800 to-gray-900 p-6 rounded-lg shadow-md mt-6">
              ...
              {decryptionType === "text" && (
                ...
                className={`px-8 py-4 text-l font-bold text-white bg-gradient-to-r from-blue-gray-700 to-teal-800 rounded-md shadow-md
                            hover:scale-105 hover:shadow-lg transition-all duration-300
                            ${decryptionAlgorithm === "aes" ? "border-4 border-blue-300" : ""} flex items-center justify-center`}
                  >
                    AES
                  </button>
                  <button
                ...
                className={`px-8 py-4 text-l font-bold text-white bg-gradient-to-r from-blue-gray-700 to-teal-800 rounded-md shadow-md
                            hover:scale-105 hover:shadow-lg transition-all duration-300
                            ${decryptionAlgorithm === "rsa" ? "border-4 border-blue-300" : ""} flex items-center justify-center`}
                  >
                    RSA
                  </button>
                  <button
                ...
                className={`px-8 py-4 text-l font-bold text-white bg-gradient-to-r from-blue-gray-700 to-teal-800 rounded-md shadow-md
                            hover:scale-105 hover:shadow-lg transition-all duration-300
                            ${decryptionAlgorithm === "dsa" ? "border-4 border-blue-300" : ""} flex items-center justify-center`}
                  >
                    DES
                  </button>
                  <button
                ...
                className={`px-8 py-4 text-l font-bold text-white bg-gradient-to-r from-blue-gray-700 to-teal-800 rounded-md shadow-md
                            hover:scale-105 hover:shadow-lg transition-all duration-300
                            ${decryptionAlgorithm === "sha" ? "border- 4border-blue-300" : ""} flex items-center justify-center`}
                  >
                    SHA
                  </button>
                </>
