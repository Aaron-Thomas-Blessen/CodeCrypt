          ...
          <div className="container mx-auto px-4">
            <div className="text-center">
              ...
              <p className="text-base text-gray-700 mb-8">
                ...
                or any other service provider, weve got you covered. Our
                ...
                that youre hiring experienced professionals who will deliver
                high-quality work. Dont settle for anything less than the best
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
              <div className="lg:col-span-1">
                ...
                <div className="text-center mt-8">
                  <img
                    className="mx-auto mb-2 w-8 h-auto"
                    src={("../images/home repair icon.png")}
                    alt="carpentryicon"
                  />
              ...
              <div className="lg:col-span-1">
                <div className="text-center">
                  ...
                  <p>
                    Find skilled workers in your area for all your homes
          ...
          <div className="flex flex-col">
            <div className="py-8 text-center">
              ...
              <h6 className="text-sm mt-2">
                Get in touch with us to explore opportunities, ask questions, or share feedback. Were here to help!
              </h6>
            </div>
